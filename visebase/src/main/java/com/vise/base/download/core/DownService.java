...
public class DownService extends Service {
    ...
    private Map<String, DownOperate> mNowDownloading;
    private Queue<DownOperate> mWaitingForDownload;
    private Map<String, DownOperate> mWaitingForDownloadLookUpMap;
    ...
    public void addDownOperate(DownOperate mission) throws IOException {
    ...
    private class DownOperateDispatchRunnable implements Runnable {
        ...
        public void run() {
            while (!Thread.currentThread().isInterrupted()) {
                DownOperate mission = mWaitingForDownload.peek();
                if (null != mission) {
                    String url = mission.getUrl();
