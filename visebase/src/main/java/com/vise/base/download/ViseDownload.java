...
import com.vise.base.download.core.DownHelper;
import com.vise.base.download.core.DownOperate;
import com.vise.base.download.core.DownService;
...
public class ViseDownload {
    ...
    private ViseDownload(Context context) {
        mDownloadHelper = new DownHelper(context);
    }

    public static ViseDownload getInstance(Context context) {
        return new ViseDownload(context);
    }
